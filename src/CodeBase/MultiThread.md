...
> 相关章节：[异步（C#）](../Language/AsyncCSharp)、[异步编程实践](../CodeImplement/AsynchronousInPractice)
...
使用C# Task，相对Unity JobSystem的繁文缛节，它更加易用。但相对的，开发者需要自行管理多线程可能会出现的脏读写问题，以及与Unity API的兼容问题。
