...
在[GAMES104-现代游戏引擎：从入门到实践，第十五讲](https://www.bilibili.com/video/BV1u34y1H7jd)中，王希老师认为Gameplay在引擎层面是很难被Cover的一部分，每种不同的玩法或新颖的feature都依赖于独立的实现，更偏向工程实践问题。

## 我认为

下面一张思维导图，汇总了我对gameplay程序员的理解，感觉市面上的gameplay程序员和相关品类玩法是绑定的:
