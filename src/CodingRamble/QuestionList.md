...
[GAMES104-现代游戏引擎：从入门到实践，第20讲](https://www.bilibili.com/video/BV1Md4y1G7zp)中，提到了一系列OOP的问题。游戏引擎常用的组件模式就是基于OOP的

1. A类攻击B类，攻击这个“动作”归属于哪个类？
2. 一个核心类的基类往往很大
3. 内存散布在各处，不利于CPU cache命中
4. 逻辑散布在一个个继承类中，看逻辑的时候很不方便
5. 测试性不佳，该一段代码要测类中的其他相关逻辑
