...
除此之外，还有改善GC暂停的增量式GC，例如通过三色标记法实现增量GC
...
unity在编译方式为il2cpp时（常用的编译方式），使用的GC算法为BOEHM GC[【参考】](https://docs.unity3d.com/6000.3/Documentation/Manual/performance-incremental-garbage-collection.html)，是一种保守垃圾回收机制（相对于java和c#的精准机制）。
